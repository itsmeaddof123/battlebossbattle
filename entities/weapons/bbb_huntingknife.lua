if SERVER then
    AddCSLuaFile()
    resource.AddFile("models/weapons/v_ozark_t.mdl")
    resource.AddFile("models/weapons/w_ozark_t.mdl")
    resource.AddFile("materials/models/weapons/v_models/camp_knife/knife_1_uv.vmt")
    resource.AddFile("materials/models/weapons/v_models/camp_knife/normal.vtf")
end

SWEP.Author             = "add___123"
SWEP.Base               = "weapon_base"
SWEP.PrintName          = "Hunting Knife"
SWEP.Instructions       = ""

SWEP.ViewModel          = "models/weapons/v_ozark_t.mdl"
SWEP.WorldModel         = "models/weapons/w_ozark_t.mdl"
