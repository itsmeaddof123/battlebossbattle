...
local models = {
    {model = "models/props_building_details/Storefront_Template001a_Bars.mdl", health = 100, offset = Vector(0, 0, 35), angle = Angle(90, 0, 90)},
    ...
    {model = "models/props_phx/trains/track_512.mdl", health = 300, offset = Vector(0, 0, 45), angle = Angle(0, 0, 90)},
